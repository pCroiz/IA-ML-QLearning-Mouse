# Take from : https://github.com/giorgionicoletti/deep_Q_learning_maze/blob/master/maze_generator/maze_generator.py
...
maze = 1 - np.array(maze)
        
maze[0][0] = 1
maze[mx-1][my-1] = 1

np.save('maze_generator/maze', np.float16(np.array(maze)))